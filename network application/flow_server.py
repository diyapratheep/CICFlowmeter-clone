...
# scaler_path = os.path.join(BASE_DIR, "network application", "models", "scaler_new_xgb.pkl")
# model_path = os.path.join(BASE_DIR, "network application", "models", "xgboost_model_new.pkl")
